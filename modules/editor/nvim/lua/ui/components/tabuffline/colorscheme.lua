...
return {
  ...
  TbLineBufOff = { fg = colors.white, bg = colors.base01 },
  TbLineBufOnModified = { fg = colors.green, bg = colors.black },
  TbBufLineBufOffModified = { fg = colors.red, bg = colors.base01 },
  TbLineBufOnClose = { fg = colors.red, bg = colors.black },
  TbLineBufOffClose = { fg = colors.grey00, bg = colors.base01 },
